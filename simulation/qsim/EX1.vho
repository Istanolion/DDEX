...
-- Equation(s):
-- \S~1_combout\ = \A[1]~input_o\ $ (\B[1]~input_o\ $ (((\A[2]~input_o\ & \B[2]~input_o\))))
...
-- Equation(s):
-- \S~2_combout\ = (\A[1]~input_o\ & ((\B[1]~input_o\) # ((\B[2]~input_o\ & \A[2]~input_o\)))) # (!\A[1]~input_o\ & (\B[2]~input_o\ & (\A[2]~input_o\ & \B[1]~input_o\)))
...
-- Equation(s):
-- \S~3_combout\ = \A[0]~input_o\ $ (\B[0]~input_o\ $ (\S~2_combout\))
...
-- Equation(s):
-- \S~4_combout\ = (\A[0]~input_o\ & ((\B[0]~input_o\) # (\S~2_combout\))) # (!\A[0]~input_o\ & (\B[0]~input_o\ & \S~2_combout\))
